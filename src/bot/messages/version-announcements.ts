...
export const versionAnnouncements: Record<string, string | AnnouncementMessage> = {
  ...
  '0.11.0':
    '📚 Версия 0.11.0. Обновлённая «Библиотека»: травы по традициям и категориям, поиск и составы со ссылками на их травы.',
  '0.12.0':
    '🌿 Версия 0.12.0. Советы дня переписаны — точнее, ближе к источнику, со ссылками на главы книги «Наука о здоровье».',
  '0.13.0':
    '🧪 Версия 0.13.0. Карточки составов теперь показывают показания, традиционное применение и рекомендации по приёму.',
  '0.14.0':
    '📖 Версия 0.14.0. В Библиотеке появились статьи — начните с «Основ тибетской медицины». Откройте 📖 Статьи или /guides.',
  '0.15.0':
    '🧪 Версия 0.15.0. Карточки составов стали нагляднее: выделенные заголовки, состав списком и сворачиваемые блоки с подробным описанием.',
  '0.16.0':
  ...
  '0.18.0':
    '🧪 Версия 0.18.0. Раздел «Формулы» теперь называется «Составы», и в нём появился отдельный поиск по составам.',
  '0.19.0':
    '🥗 Версия 0.19.0. Новый раздел «Продукты»: природа, вкус и для кого подходит каждый продукт, с подбором по свойствам. Откройте 🥗 Продукты или /foods.',
  '0.20.0':
    '🌿 Версия 0.20.0. «Совет дня» пополнился — десятки новых советов о питании, образе жизни и основах традиции.',
  '0.21.0':
    '🌿 Версия 0.21.0. Раздел «Травы» стал «Ингредиентами» — 35 трав, минералов и специй, и составы теперь ссылаются на них.',
  '0.22.0':
    '🌿 Версия 0.22.0. Кнопка «Советы», /tips и Библиотека теперь показывают случайный совет при каждом нажатии.',
  '0.23.0':
    '📖 Версия 0.23.0. Большое пополнение раздела «Статьи»: 27 новых статей об основах, питании и образе жизни традиции. Откройте 📖 Статьи или /guides.',
  '0.24.0': '⏰ Версия 0.24.0. Теперь напоминания можно ставить и на полчаса — например, в 14:30.',
  '0.25.0':
    '🧪 Версия 0.25.0. Напоминание можно привязать к составу и указать, как его принимать — с тёплой водой или отваром.',
  '0.26.0':
    '🕰 Версия 0.26.0. Теперь у напоминаний есть ваш часовой пояс — выберите город в ⚙️ Настройках, и они сработают в нужное местное время.',
  '0.27.0':
    '📖 Версия 0.27.0. Новые статьи об устройстве традиции: древо медицины, истоки и разделы, четыре способа лечения и виды лекарств. Откройте 📖 Статьи или /guides.',
};
